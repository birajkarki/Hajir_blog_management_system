...
// import { getAllCategory } from '../../../Backend/controllers/category.controller';
...
//       return categories.categories; // Assuming categories is the correct key
//     } catch (error) {
//       console.log(error);
//       return []; // Return an empty array on error
//     }
...
//     try {
//       const subCategories = await ApiRequest.get(`/${templateId}/${categoryId}/subcategory`);
